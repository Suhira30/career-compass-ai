...
*AI-Powered Career Navigation, Skill Gap Analysis & Upskilling Platform*
...
## 1. Project Title
**Career Compass AI** — *Intelligent Career Copilot for Resume Parsing, Skill Gap Analysis, Personalized Learning Roadmaps, and Contextual Career Guidance.*
...
│   │   ├── services/
│   │   │   ├── extractors/  # Resume & Job Description LLM Parsers
...
sequenceDiagram
    ...
    API->>AI: Compare Profile Skills vs JD Requirements
    ...
    API->>RAG: Retrieve Vector Context + Stream LLM Answer
...
OPENAI_API_KEY=your_openai_api_key_here_if_applicable
